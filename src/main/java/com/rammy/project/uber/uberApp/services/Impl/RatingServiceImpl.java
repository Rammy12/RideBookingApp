...
import com.rammy.project.uber.uberApp.entities.Rating;
...
import com.rammy.project.uber.uberApp.repositories.RatingRepository;
...
public class RatingServiceImpl implements RatingService {
    ...
    public DriverDto rateDriver(Ride ride, Integer rating) {
        ...
        if (ratingObj.getDriverRating()!=null) throw new RuntimeConflictException("Driver has been rated cannot rate again");
    ...
    public RiderDto rateRider(Ride ride, Integer rating) {
        ...
        if (ratingObj.getRiderRating()!=null) throw new RuntimeConflictException("Rider has been rated cannot rate again");
    ...
    @Override
    public void creatingNewRating(Ride ride) {
